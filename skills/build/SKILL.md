...
8. Always update the readme and add any instructions after you are done with a build unless told not to do so.
...
- When you are finished with the task, say you've completed task X of Y to let the user know what step you just finished and how many are left
